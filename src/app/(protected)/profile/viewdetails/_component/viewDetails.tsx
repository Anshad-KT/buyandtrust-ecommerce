...
//                         const orderDetails = data.find((item: any) => item.sale_id === id)
//                         if (orderDetails) {
...
//                                 })
//                             }
//                             console.log("Transformed orderDetails", orderDetails)
//                         }
//                         setLoading(false)
//                     },
//                     afterError: () => {
...
//     function mapOrderStatus(status: string): "placed" | "packaging" | "shipping" | "delivered" {
...
//             <section className="bg-white p-1 rounded-none border border-[#E4E7E9] mb-8">
//             <div className="mb-6">
...
//                         </p>
//                     </div>
//                     <div className="text-2xl font-bold text-blue-500 mt-2 md:mt-0">₹{orderData.total_price || 
//                         orderData.product_details?.reduce((sum: number, item: any) => sum + (item.total_price || 0), 0) || 0}</div>
//                 </div>
//             </div>
...
//                         <div
//                             className="h-2 bg-orange-500 absolute top-0 left-0 z-10"
...
//                                 </div>
//                             </div>
//                             <p className="text-xs mt-2 text-center">Packaging</p>
//                         </div>
...
//                                 </div>
//                             </div>
//                             <p className="text-xs mt-2 text-center">On The Road</p>
//                         </div>
...
//                 {/* Desktop View */}
//                 <div className="hidden md:block bg-gray-50 rounded-md overflow-hidden">
...
//                         orderData.product_details.map((product: any, index: number) => (
...
//                     {orderData.product_details && orderData.product_details.length > 0 ? (
//                         orderData.product_details.map((product: any, index: number) => (
//                             <div key={product.sale_item_id || index} className="bg-gray-50 rounded-md p-4 mb-4 border border-gray-200">
//                                 <div className="flex mb-3">
//                                     <div className="w-20 h-20 mr-3 bg-white border rounded-md overflow-hidden flex-shrink-0">
//                                         {product.item?.images?.[0]?.url ? (
//                                             <Image
//                                                 src={product.item.images[0].url}
//                                                 alt={product.item?.name || "Product"}
...
//                             <span className="font-medium">Phone Number:</span> {orderData.customer?.phone || orderData.customer_phone}
//                         </p>
                    ...
                    afterSuccess: (data) => {
                        ...
                        if (orderDetails) {
                            ...
                            if (orderDetails.product_details && Array.isArray(orderDetails.product_details)) {
                                ...
                                setOrderData({
                                    ...orderDetails,
                                    product_details: orderDetails.sale_items?.map((item) => ({
                                        id: item.item_id,
                                        sale_item_id: item.sale_item_id,
                                        item_name: item.item?.name,
                                        description: item.item?.rich_text || "",
