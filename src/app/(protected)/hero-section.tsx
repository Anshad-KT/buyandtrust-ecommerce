...
//   // Simulate user authentication state and info
//   // Replace this logic with your actual authentication logic
//   const [user, setUser] = useState<{ name?: string; email?: string } | null>(null);

//     useEffect(() => {
//       // Example: Check localStorage or API for user info
//       // Replace with your real authentication check
//       makeApiCall(async () => {
//         const userData = await new EcomService().getUserDetails()
...
//   // Button style for login/profile (matches the image)
//   const loginButtonClass =
//     "lg:block hidden px-8 py-2 rounded-xl border-2 border-white text-white font-bold text-2xl bg-transparent transition-colors duration-200 hover:bg-white hover:text-[#1C1C24] focus:outline-none";
...
//                 transition={{ type: "spring", stiffness: 300 }}
//               >
//                 <span className={`lg:block hidden ${pathname == "/profile/my-profile" ? "text-[#fe3232] hover:text-white" : "text-white hover:text-[#fe3232]"}`}>{user?.name}</span>
//               </motion.a>
//             ) : (
//             // Comment out login component and auth logic
//             /*
...
//               transition={{ type: "spring", stiffness: 300 }}
//             >
//               <span className={`${pathname == "/profile/address" ? "text-[#fe3232] hover:text-white" : "text-white hover:text-[#fe3232]"}`}>Sign in</span>
//             </motion.a>
//             )}
