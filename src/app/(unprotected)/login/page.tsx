...
//       toastWithTimeout(ToastVariant.Default, "A login code has been sent to your email.")
//     } catch (error: any) {
//       console.error("Send OTP error:", error)
//       toastWithTimeout(ToastVariant.Default, error?.message || "An error occurred while sending the code")
//     } finally {
//       setIsLoading(false)
//     }
//   }
...
//     e.preventDefault()
//     if (!otp.trim()) {
//       toastWithTimeout(ToastVariant.Default, "Please enter the code sent to your email.")
//       return
//     }
//     setIsLoading(true)
//     try {
...
//       toastWithTimeout(ToastVariant.Default, error?.message || "Invalid or expired code.")
//     } finally {
//       setIsLoading(false)
//     }
//   }
...
//             </div>
//             <Button
//               className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium h-10 rounded-none mt-4"
//               disabled
//             >
